...
let latestTips = {
  ...
  "ไลฟ์สด": "📺 ไลฟ์สดยังไม่มีน้ารออัพอีกทีเย็นๆนะเตง"
};
...
app.post("/webhook", express.json(), (req, res) => {
  Promise.all(req.body.events.map(async (event) => {
    ...
    if (msg === "เมนู" || now - lastShown > ONE_HOUR) {
      ...
      replies.push({ type: "text", text: "สวัสดีค่า 😊 น้องยูริ แอดมินจาก UFA888PRO ยินดีให้บริการค่ะ\n\nหากพี่มีคำถามเกี่ยวกับโปรโมชั่น สมัคร ฝากถอน หรือติดปัญหาอะไร ทักมาได้ตลอดเลยนะคะ 💬💚" });
      replies.push({
        type: "flex",
        altText: "เมนูหลัก UFA888PRO",
...
app.listen(port, () => console.log("✅ LINE BOT UFA888PRO is running on port", port));
